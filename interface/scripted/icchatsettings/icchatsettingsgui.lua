...
function init()
  ...
  self.portraitCanvas = widget.bindCanvas("main.portraitCanvas")
...
function updateLayouts()
  if widget.getSelectedData("layouts") == "text" then
    widget.setVisible("main", false)
    widget.setVisible("text", true)
  else
    widget.setVisible("main", true)
